...
namespace App.Simples.CellsInventory
{
    public sealed class Inventory
    {
        ...
        public int GetCount(SSOKey key)
        {
            int resultCount = 0;
        ...
        public void AddItem(SSOKey key, int count)
        {
        ...
        public void RemoveItem(SSOKey key, int count)
        {
        ...
        public void RemoveItemFromCell(SSOKey key, int count, int cellIndex)
        {
        ...
        public int CheckSpaceInInventory(SSOKey key)
        {
            int maxCountInCell = _inventoryConfigurations.GetCountInCell(key);
            int spaceCount = 0;
            for (int i = 0; i < _size; i++)
        ...
        private void DefineEmptyCells(SSOKey key, out List<int> emptyCells, out List<int> suitableCells)
        {
            emptyCells = new();
            suitableCells = new();
